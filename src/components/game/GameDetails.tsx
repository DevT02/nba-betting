...
function GameDetails({
  ...
  // Filter previews for Today vs Upcoming
  const todayPreviews =
  ...
  const upcomingPreviews =
    gameIds && gamePreviews
      ? gameIds
          ...
          .filter((game) => {
            const gameTime = new Date(game.commence_time);
            return gameTime > endOfToday; // games after today
          })
      : [];

  // Header height for adjusting banners (if needed)
      ...
      <main className="mx-auto px-4 sm:px-6 lg:px-8 mt-6 max-w-none">
        {(isMobile || isTablet) ? (
          ...
          <motion.div
            ...
            className="w-full rounded-2xl shadow-lg border border-gray-200 dark:border-zinc-800
                       p-4 sm:p-6 md:p-8 min-h-[550px] flex flex-col justify-between"
            style={{
          ...
          >
            {/* ---- Main Mobile Content ---- */}
            <div className="flex flex-col items-center gap-4 mb-4 max-w-6xl w-full mx-auto">
              {/* Header: Teams, Date, Time, Arena */}
              ...
              {/* Three small info chips: Date, Time, Location */}
              ...
              {/* Horizontal scroll info row: H2H, Over/Under, Injuries */}
              <div className="py-1 w-full">
                <div className="border-t border-b border-gray-100 dark:border-gray-800/50 relative">
                  ...
                  <div
                    ...
                    className="py-3 flex items-center justify-start sm:justify-center gap-x-4 
                               overflow-x-auto whitespace-nowrap px-4 text-xs scroll-pl-0
                               sm:scroll-pl-4"
                    style={{
                      touchAction: "pan-x",
              ...
              <div className="flex flex-col items-center gap-2.5 border border-yellow-200
                              dark:border-yellow-900/50 p-3 rounded-xl w-full
                              bg-gradient-to-b from-yellow-50/40 to-transparent
                              dark:from-yellow-900/20 shadow-sm mb-4"
              >
                      ...
                      <InfoTooltip
                        text={
                          <div>
                            ...
                            <p>
                              Our model analyzes team performance over a season along
                              with historical matchups to bring you the best results.
                            </p>
                          </div>
                        }
                  ...
                  <div className="flex justify-between items-center mb-3 relative">
                    {orderedTeamNames.map((team, index) => {
                      ...
                      return (
                        ...
                        >
                          <div
                            className={`w-7 h-7 sm:w-8 sm:h-8 rounded-full p-1 flex items-center justify-center shadow-sm ${
                              isWinner
                    ...
                    <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2">
                      ...
                      >
                        <span
                          className="text-[9px] font-extrabold bg-clip-text text-transparent
                  ...
                  <div className="h-3 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden relative shadow-inner">
                    {(() => {
                      ...
                      let prob1 = parseFloat(
                        oddsData[team1][0]?.probability?.replace("%", "") || "0"
                      );
                      let prob2 = parseFloat(
                        oddsData[team2][0]?.probability?.replace("%", "") || "0"
                      );
                          ...
                          <div
                            className={`absolute inset-y-0 right-0 rounded-r-full ${
                              isTeam2Winner
                                ...
                                : "bg-gradient-to-l from-red-400 to-red-500 dark:from-red-500 dark:to-red-500"
                            }`}
                            style={{ width: `${prob2}%` }}
                          >
                            {prob2 > 15 && (
          ...
          <div className="grid grid-cols-12">
            ...
            <aside className="hidden xl:block col-span-2 ">
              <InfoBanner headerHeight={headerHeight} />
            </aside>
          </div>
        )}
      </main>
